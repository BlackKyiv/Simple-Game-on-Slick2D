...
import org.newdawn.slick.state.StateBasedGame;
    ...
    public class MapLevel1 extends BasicGameState {
        ...
        private DummyEnemy dummy1;
        private DummyEnemy dummy2;
        private Door door;
        ...
        private void initEnemies(){
            dummy = new DummyEnemy(300,SetupGame.height-150, 50,50);
            dummy1 = new DummyEnemy(500,SetupGame.height-150, 50,50);
            dummy2 = new DummyEnemy(400,SetupGame.height-150, 50,50);
        }
        ...
        public void render(GameContainer gameContainer, StateBasedGame stateBasedGame, Graphics graphics) throws SlickException {
            ...
            drawDoors(graphics);//if door is not broken then draw it
        ...
        private void drawDummies(Graphics graphics){
            ...
            if(dummy1.isAlive()) {
                graphics.setColor(Color.green);
                graphics.fill(dummy1);
            }

            if(dummy2.isAlive()) {
                graphics.setColor(Color.green);
                graphics.fill(dummy2);
            }
        ...
        private void checkForAttack(GameContainer container){
            ...
            if(attackZone.intersects(dummy)) dummy.die();
            if(attackZone.intersects(dummy1)) dummy1.die();
            if(attackZone.intersects(dummy2)) dummy2.die();
